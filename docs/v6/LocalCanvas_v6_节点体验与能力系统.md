...
> **生成日期**：2026-06-05  
> **设计详案**：`docs/v6/design/`（本目录 `./design/`，三份重设计原文）  
> **开发步骤**：[开发步骤表](../../LocalCanvas_开发步骤表.md) Phase 6
...
| 主线 | 设计文档 | 一句话 |
|------|----------|--------|
| **合成编辑器** | [合成编辑器重设计](./design/LocalCanvas_合成编辑器重设计.md) | 画布管连线，剪辑台管排列与导出 |
| **文本节点** | [文本节点重设计](./design/LocalCanvas_文本节点重设计.md) | 草稿/输出分离，连线永远走 `output` |
| **模型能力系统** | [模型能力系统重设计](./design/LocalCanvas_模型能力系统重设计.md) | 边是否合法由「上游模态 × 下游槽位」决定 |
...
| **D. 横切** |
| 33 | 实施记录 | `v6/design/LocalCanvas_模型能力系统重设计.md` 附录 D | P0 | ✅ | — |
...
实施记录见：[模型能力系统重设计 · 附录 D](./design/LocalCanvas_模型能力系统重设计.md#附录-d实施记录2026-06-05)（Task 13–20）。
...
| 实施记录 | [模型能力系统重设计 · 附录 D](./design/LocalCanvas_模型能力系统重设计.md#附录-d实施记录2026-06-05) |
...
**目标**：确认 [合成编辑器重设计](./design/LocalCanvas_合成编辑器重设计.md) §八成功标准。
...
**目标**：确认 [文本节点重设计](./design/LocalCanvas_文本节点重设计.md) §九成功标准。
...
**目标**：跑通 [模型能力系统重设计](./design/LocalCanvas_模型能力系统重设计.md) 评审决议五项。
...
- 更新 [模型能力系统重设计 · 附录 D](./design/LocalCanvas_模型能力系统重设计.md#附录-d实施记录2026-06-05) 与 v6 总表状态一致
- 三份设计文档已归档至 `docs/v6/design/`（本目录 `./design/`）（本步骤）
...
见 [合成编辑器重设计 §五](./design/LocalCanvas_合成编辑器重设计.md)。
...
| 文档 | 路径 | 状态 |
|------|------|------|
| 合成编辑器重设计 | [v6/design/LocalCanvas_合成编辑器重设计.md](./design/LocalCanvas_合成编辑器重设计.md) | ✅ 基线已实施 |
| 文本节点重设计 | [v6/design/LocalCanvas_文本节点重设计.md](./design/LocalCanvas_文本节点重设计.md) | ✅ 基线已实施 |
| 模型能力系统重设计 | [v6/design/LocalCanvas_模型能力系统重设计.md](./design/LocalCanvas_模型能力系统重设计.md) | ✅ 核心已实施 |
| 能力系统实施记录 | [v6/design/LocalCanvas_模型能力系统重设计.md · 附录 D](./design/LocalCanvas_模型能力系统重设计.md#附录-d实施记录2026-06-05) | Task 13–20 ✅ |
...
摘自 [模型能力系统重设计 §零](./design/LocalCanvas_模型能力系统重设计.md)：
...
*本文档由三份重设计文档梳理生成，作为 v6 客户端迭代的需求基线。能力系统实施记录见设计文档附录 D；未关闭项见 [v10 技术债归集](../../LocalCanvas_v10_项目优化与技术债归集.md)。*
