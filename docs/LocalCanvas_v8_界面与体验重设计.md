...
> **生成日期**：2026-06-06  
> **设计详案**：`docs/v8/design/`（三份界面专文 + 图片节点专文）  
...
| **图片 ImageEditorPanel** | ✅ | Phase 0–2，见 [图片节点与生成器重设计](./v8/design/LocalCanvas_图片节点与生成器重设计.md) §十三 |
...
> 完整 Token 表见 [v8/design/01_视觉语言与设计令牌.md](./v8/design/01_视觉语言与设计令牌.md)
...
> 详规见 [v8/design/02_编辑器壳层与三模式布局.md](./v8/design/02_编辑器壳层与三模式布局.md)
...
> 详规见 [v8/design/03_交互语法与微反馈.md](./v8/design/03_交互语法与微反馈.md)
