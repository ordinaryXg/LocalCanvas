...
| TC-M-SB-006 | P1 | ~~导出 PDF~~ | — | — | ~~`outputs/storyboard.pdf` 可打开~~ | **废弃**（v9 移除 PDF 导出；见 [v9 Wave 5](../../v9/LocalCanvas_v9_精简优化与体验收官.md)） |
...
用例状态列请在每次测试执行后维护（⬜ 未测 / ✅ 通过 / ❌ 失败 / ⏭ 跳过 / **废弃** 产品已移除，不再执行）。

| 用例 ID | 废弃说明 |
|---------|----------|
| TC-M-SB-006 | v9 移除分镜 PDF 导出；保留 PNG 拼图与 4K 单帧（`TC-M-SB-005` / `TC-M-SB-007`） |
